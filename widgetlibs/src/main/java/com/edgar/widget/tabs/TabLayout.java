...
import com.edgar.AnimationUtils;
import com.edgar.res.MaterialResources;
import com.edgar.utils.RippleUtils;
import com.edgar.utils.ViewUtils;
import com.edgar.widget.R;
...
public class TabLayout extends HorizontalScrollView {
  ...
  public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    bottomDividerHeight = a.getDimensionPixelOffset(R.styleable.TabLayout_bottomDividerHeight,0);
    bottomDivider = a.getDrawable(R.styleable.TabLayout_bottomDivider);

    tabTextAppearance =
        a.getResourceId(R.styleable.TabLayout_tabTextAppearance, R.style.TabText);
    ...
    try {
      tabTextSize = ta.getDimensionPixelSize(android.support.v7.appcompat.R.styleable.TextAppearance_android_textSize,0);
      tabTextColors =
    ...
    tabTextMultiLineSize = res.getDimensionPixelSize(R.dimen.tab_text_size_2line);
    scrollableTabMinWidth = res.getDimensionPixelSize(R.dimen.tab_scrollable_min_width);
  ...
  class TabView extends LinearLayout {
    ...
    private void updateBackgroundDrawable(Context context) {
      if (tabBackgroundResId != 0) {
        ...
        baseBackgroundDrawable = RippleUtils.createRippleDrawable(tabRippleColorStateList,unboundedRipple);
      }
      ...
      if (customView == null) {
          ...
          ImageView iconView =
              (ImageView)
                  LayoutInflater.from(getContext())
                      .inflate(R.layout.tab_icon_layout, this, false);
          addView(iconView, 0);
        ...
        if (this.textView == null) {
          TextView textView =
              (TextView)
                  LayoutInflater.from(getContext())
                      .inflate(R.layout.tab_text_layout, this, false);
          addView(textView);
  ...
  private class SlidingTabIndicator extends LinearLayout {
    ...
    public void draw(Canvas canvas) {
      if (bottomDivider != null) {
        int dividerHeight = bottomDivider.getIntrinsicHeight();
        if (bottomDividerHeight > 0) {
           dividerHeight = bottomDividerHeight;
        }
        bottomDivider.setBounds(0, getHeight()-dividerHeight, getWidth(), getHeight());
